import heroImage from "../../assets/images/main/hero.svg";
...
export function Hero() {
  return (
    <section className='py-14 px-0'>
      <div className={`container flex flex-wrap item-center gap-[30px] md:flex-nowrap`}>
        <div className="left">
          <h1 className='mb-4 max-w-[405px] md:text-[40px]'>
          ...
          <Button content="Get started" href="/" />
        </div>
        <div className="right">
